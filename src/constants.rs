...
pub(crate) const FIRST_COMIC: &str = "1989-04-16";
...
pub(crate) const CACHE_LIMIT: f32 = 9900.0;
/// No. of hrs after scraping the latest date when it is to be scraped again
pub(crate) const LATEST_DATE_REFRESH: f64 = 2.0;

// ==================================================
// Miscellaneous
// ==================================================
/// URL prefix for each comic on "dilbert.com"
pub(crate) const SRC_PREFIX: &str = "https://dilbert.com/strip/";
